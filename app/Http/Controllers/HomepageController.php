...
class HomepageController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $cData->neyapiyoruz = post::where('category_id', 3)->orderBy('publish_time')->get();
        $cData->nasilyapiyoruz = post::where('category_id', 4)->orderBy('publish_time')->first();
        $cData->bizkimiz = post::where('category_id', 5)->orderBy('publish_time')->first();
        $cData->portfolyo = post::where('category_id', 6)->orderBy('publish_time')->get();
    ...
    public function post(Request $request)
    {
        ...
        $cData = new \ArrayObject();
        $cData->category = category::where("id", 6)->first();
        $cData->data = post::find(request("id"));
        $cData->previous = post::where('id', '<' ,$cData->data->id)->orderByDesc('id')->first();
        $cData->next = post::where('id', '>' ,$cData->data->id)->orderBy('id')->first();

     return view('home.post', ['cData' => $cData]);
    }

    public function neyapiyoruz(Request $request)
    {
        ...
        $cData->posts = post::where("category_id", 3)->get();

        return view('home.neyapiyoruz', ['cData' => $cData]);
    }
    ...
    public function blog(Request $request)
    {
        ...
        $cData = new \ArrayObject();
        $cData->posts = post::where("category_id", 8)->get();

        return view('home.blog', ['cData' => $cData]);
    }
    ...
    public function blogDetail(Request $request)
    {
        ...
        return view('home.blogDetail', ['cData' => $cData]);
    }
